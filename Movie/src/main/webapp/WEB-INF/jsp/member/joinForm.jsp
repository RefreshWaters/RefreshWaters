...
<form action="add" method="post" name="frm">
	<input type="text" name="mb_ID" id ="id" placeholder="ID">
	<span id="dupIdMsg"></span>
	<br>
	<input type="password" name="mb_passwd" id="passwd"placeholder="PASSWORD"><br>
...
<!-- 	<span id=""></span> -->
	...
	<input type="button" id="check_btn" value="코드인증"><br>
 	<input type="hidden" name="" id="email_code" value="0">
 	<input type="text" name="mb_phone" id="phonN" placeholder="ex)010-4567-1234"><br>
